...
train_pipeline = [
    ...
    dict(type='Collect', keys=['softmax_distance', 'gt_semantic_seg']),
]
test_pipeline = [
    dict(type='LoadLogit'),
    dict(type="LoadSoftmaxDistanceFromLogit"),
    # dict(type="LogitMinMaxNormalize", method="global"),
    dict(type='DefaultFormatBundle'),
    dict(type='Collect', keys=['softmax_distance']),
]
