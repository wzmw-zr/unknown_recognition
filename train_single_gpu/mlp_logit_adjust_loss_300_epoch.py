...
if __name__ == "__main__":
    ...
    cfg.work_dir = f'./work_dirs/anomal_datasets/mlp_logit_with_softmax_lr_{lr}_epoch_{epoch}_policy_{policy}_unknown_{unknown_ratio}_known_{known_ratio}_norm_{logit_norm_type}'
