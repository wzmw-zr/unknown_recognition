...
if __name__ == "__main__":
    ...
    cfg = Config.fromfile("configs/mlp/mlp_softmax_distance_tversky_loss_100_epoch.py")
    ...
    cfg.work_dir = f'./work_dirs/anomal_datasets/mlp_softmax_distance_lr_{lr}_epoch_{epoch}_policy_{policy}_layer_norm_{norm_type}_{alpha}_{beta}'
