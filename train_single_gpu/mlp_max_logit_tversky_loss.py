...
if __name__ == "__main__":
    ...
    cfg = Config.fromfile("configs/mlp/mlp_max_logit_tversky_loss_100_epoch.py")
    ...
    cfg.work_dir = f'./work_dirs/anomal_datasets/mlp_max_logit_lr_{lr}_epoch_{epoch}_policy_{policy}_logit_norm_{logit_norm_type}_layer_norm_{norm_type}_{alpha}_{beta}'
